...
/****** Object:  Database [EmailSystem]    Script Date: 3/19/2018 4:57:38 PM ******/
CREATE DATABASE [EmailSystem]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'EmailSystem', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\EmailSystem.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'EmailSystem_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\EmailSystem_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [EmailSystem] SET COMPATIBILITY_LEVEL = 110
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [EmailSystem].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
...
ALTER DATABASE [EmailSystem] SET AUTO_CREATE_STATISTICS ON 
GO
...
ALTER DATABASE [EmailSystem] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [EmailSystem] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [EmailSystem] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
